      ...
      <div className='max-w-2xl md:max-w-xl lg:max-w-8xl mx-auto' ref={el}>
        ...
        <div className='max-h-screen grid grid-cols-2 lg:grid-cols-4 gap-1 mt-8  '>
          <div className='relative w-full aspect-square  opacity-0 fadeIn'>
            <Image
              placeholder='blur'
              blurDataURL={'/img/Valeria 1.jpg'}
              src={'/img/Valeria 1.jpg'}
              alt={'Valeria 1'}
              layout={'fill'}
              objectFit={'cover'}
            />
          ...
          <div className='relative w-full aspect-w-1 aspect-h-1    opacity-0 fadeIn'>
            <Image
              placeholder='blur'
              blurDataURL={'/img/Valeria 2.jpg'}
              src={'/img/Valeria 2.jpg'}
              alt={'Valeria 2'}
              layout={'fill'}
              objectFit={'cover'}
            />
          ...
          <div className='relative w-full aspect-w-1 aspect-h-1   opacity-0 fadeIn'>
            <Image
              placeholder='blur'
              blurDataURL={'/img/Valeria 3.jpg'}
              src={'/img/Valeria 3.jpg'}
              alt={'Valeria 3'}
              layout={'fill'}
              objectFit={'cover'}
            />
          ...
          <div className='relative w-full aspect-w-1 aspect-h-1 opacity-0 fadeIn'>
            <Image
              placeholder='blur'
              blurDataURL={'/img/Valeria 4.jpg'}
              src={'/img/Valeria 4.jpg'}
              alt={'Valeria 4'}
              layout={'fill'}
              objectFit={'cover'}
            />
        ...
        <div className='flex flex-col justify-end py-12  mt-12 w-full h-full font-black sm:hidden lg:flex opacity-0 fadeIn'>
          <h1 className=' self-center text-black xl:scale-125 pr-20  z-20'>
            <span className='block text-8xl'>15s</span>
            <span className='block text-right text-3xl -mr-16 relative'>My Birthday</span>
          </h1>
        </div>
      </div>
    </section>
